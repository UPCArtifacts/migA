...
package fr.uphf.se.kotlinresearch.diff.heuristic.mtdiff.hungarian;
...
public final class Hungarian {
	...
	/**
	 * Find a minimizing solution for the linear assignment problem specified by the
	 * matrix.
	 *
	 * @param matrix the matrix
	 * @return An array with an element for each row containing the assigned column
	 *         of the matrix.
	 */
