...
package fr.uphf.se.kotlinresearch.diff.heuristic.mtdiff.similarity;

import com.github.gumtreediff.matchers.Mapping;
import com.github.gumtreediff.tree.ITree;

/**
 * A ComparePair with an additional value field. However, the value field is not
 * considered when comparing two instances of this class. Thus two instances of
 * ValueComparePair with the same elements but different values would be
 * considered equal and would return the same hash code.
 */
