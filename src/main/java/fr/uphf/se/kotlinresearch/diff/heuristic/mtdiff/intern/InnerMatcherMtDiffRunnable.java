...
public class InnerMatcherMtDiffRunnable implements Callable<ArrayList<MatchingCandidate>> {
	 ...
	 */
	public InnerMatcherMtDiffRunnable(ArrayList<ITree> unmatchedNodesOrdered1, ArrayList<ITree> unmatchedNodesOrdered2,
			AtomicInteger counter, int start, int end, InnerNodeSimilarityCalculator imatcher) {
		super();
